...
import utilDemo.TestUtility;
	...
	public class UserSetupTest extends TestBase {
		...
		//ePayment details here
			...
			// 3rd Step
			public UserSetupTest(String surname, String firstName, String otherNames, String userName, String email, String mobileNo, String selectedUser,  String positiveData ){
		...
		public void beforeTest() throws IOException{
			...
			initialize();
			ApplicationLogs.debug("Initializing the UserSetup Test");
		...
		public static Collection<Object[]> dataSupplier(){
			...
			// The variable below is the xlsx worksheet name - LoginTest
					Object[][] data = TestUtility.getDataFromExcelSheet("UserSetupTest");
