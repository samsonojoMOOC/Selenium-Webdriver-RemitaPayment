...
public class LoginTellerTest extends TestBase {
	...
	Logger ApplicationLogs = Logger.getLogger("devpinoyLogger");
		...
		public LoginTellerTest(String username, String password, String OrgId, String positiveData){
	...
	public void beforeTest() throws IOException{
		...
		// xlsx file
		if(TestUtility.isSkip("LoginTellerTest"))
	...
	public static Collection<Object[]> dataSupplier(){
		...
		// read data from xls file and write in into Object array.
				Object[][] data = TestUtility.getDataFromExcelSheet("LoginTellerTest");
