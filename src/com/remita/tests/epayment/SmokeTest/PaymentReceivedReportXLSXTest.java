...
public class PaymentReceivedReportXLSXTest extends TestBase{
	...
	public void beforeTest() throws IOException{
		...
		// xlsx file
		if(TestUtility.isSkip("PaymentReceivedReportXLSXTest"))
...
new Select(driver.findElement(By.xpath("html/body/div[3]/div/form/div[13]/div/select"))).selectByValue("xlsx");
