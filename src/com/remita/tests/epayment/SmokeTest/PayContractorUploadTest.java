...
import Util.TestUtility;
	...
	public class PayContractorUploadTest extends TestBase {
		...
		public void payContractorUploadTest() throws IOException{
			...
			new Select(getObjectByName("drd_Contractor_FundingBank")).selectByValue("759234");
			...
			new Select(getObjectByName("drd_Contractor_FundingBank")).selectByValue("1509328762755");
			ApplicationLogs.debug("Pay Contractor Upload Module: Selected bank to Remit into");
			new Select(getObjectById("drd_Contractor_FundingBank1")).selectByValue("15736234");
			ApplicationLogs.debug("Pay Contractor Upload Module: Selected bank to Remit into");
			getObjectByName("btn_Contractor_SubmitBank").click();
			...
			new Select(getObjectByName("drd_Contractor_FundingBank")).selectByValue("759525");
			ApplicationLogs.debug("Pay Contractor Upload Module: Selected bank to Remit into");
