...
import Util.TestUtility;
	...
	public class EditCollectionRuleTest extends TestBase {
		...
		//ePayment details here
			...
			// 3rd Step
			public EditCollectionRuleTest(String serviceName,  String paymentAcct,  String amount2Pay, String whoPaysProccessFee, 
		...
		public void sendOutInvoicesTest() throws IOException{
			...
			*/
			driver.findElement(By.xpath("//*[@id='form1']/div[16]/div[2]/table/tbody/tr[2]/td[2]/font")).click();
			...
			if(positiveData.equals("Y")){
				...
				System.out.println("Define Collection Rule was edited successfully");
				Assert.assertTrue("Define Collection Rule was edited successfully", true);
				...
				System.out.println("Define Collection Rule was unsuccessfully edited");
				Assert.assertTrue("Define Collection Rule was unsuccessfully edited", false);
			}
