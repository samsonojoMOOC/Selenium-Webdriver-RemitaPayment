package com.remita.tests.epayment.Payroll;
...
public class LoginPayrollTest extends TestBase {
	...
	Logger ApplicationLogs = Logger.getLogger("devpinoyLogger");
		...
		public LoginPayrollTest(String username, String password, String OrgId, String positiveData){
	...
	public void beforeTest() throws IOException{
		...
		// xlsx file
		if(TestUtility.isSkip("LoginPayrollTest"))
	...
	public static Collection<Object[]> dataSupplier(){
		...
		// read data from xls file and write in into Object array.
				Object[][] data = TestUtility.getDataFromExcelSheet("LoginPayrollTest");
